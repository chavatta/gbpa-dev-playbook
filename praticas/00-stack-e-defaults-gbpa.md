...
| Default | Valor | Opções (★ = ponto de partida) | Nota |
|---|---|---|---|
| Provedor/modelos 🔒 | **Anthropic — Opus 5.5 / Fable 5.1 / Haiku 4.5** | ★ **Anthropic** · outro provedor | Trocar exige revisar ADR-001/002/003 e a designação de modelo dos 13 agentes |
