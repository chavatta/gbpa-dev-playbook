...
|---|---------|----------------------|-------------------------------|
| 00 | [Stack e Defaults do Projeto](00-stack-e-defaults-gbpa.md) | Quais são as escolhas-padrão deste projeto? *(preenchido por projeto; campo vazio = Architect decide)* | Todos os agentes |
...
- **Todos** — 00 é o ponto de partida: os defaults do projeto vencem preferência de agente; desvio vai para ADR. Campo em branco no 00 é decisão do **Architect**, não blocker — ele decide, registra em ADR e devolve o valor ao 00.
