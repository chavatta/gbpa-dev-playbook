...
| 2 | **Alias `model: fable`** | *Superado em 2026-09-23: o topo passou a Opus 5.5, fixado pelo ID completo `claude-opus-5-5` (ADR-001).* Válido no Claude Code atual; a auto-verificação de modelo nos agentes cobre o fallback silencioso. Não precisa trocar pelo id completo | ADR-001 (revisão trimestral) |
